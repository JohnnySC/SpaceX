 ...
 */
class LaunchDateViewHolder(view: View) : LaunchDetailViewHolder<LaunchDataUiModel.LaunchDate>(view) {

    override fun bind(model: Any) {
        val value = (model as LaunchDataUiModel.LaunchDate).value
        itemView.textView.text = itemView.context.getString(R.string.launch_date, value)
    }
}